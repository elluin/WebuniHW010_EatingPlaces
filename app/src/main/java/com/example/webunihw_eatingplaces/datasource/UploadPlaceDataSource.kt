...
suspend fun uploadPlace(filepath: String, fullName: String, postalCode: String, city: String, address: String, lat: Double, lon: Double, categories: String, desription: String): NetworkResponse<Any> {
    try {
